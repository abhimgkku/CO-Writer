...
from src.domain.dataset import DatasetType, TrainTestSplit
from src.domain.prompt import GenerateDatasetSamplesPrompt, Prompt
...
Example instruction: Explain the concept of an CO Writer. \
Example answer: A CO Writer  is essentially an AI character that mimics your writing style, personality, and voice. \
